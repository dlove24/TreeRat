...
struct dom_compr_info {
  public:
    dom_compr_info (_domain _dom, int _ix, int _nl, int _nul); /**< Constructor. */
    _domain dom;                           /**< Pointer to binary domain. */
 ...
 * \param compr List of earlier compressed domain names
 */
